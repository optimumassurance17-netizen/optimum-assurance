export const faqs = [
  ...
  { q: "Comment obtenir mon attestation rapidement ?", r: "En souscrivant en ligne : devis en quelques minutes, signature électronique du contrat sur le PDF, puis paiement du premier trimestre et des frais de gestion par carte bancaire, avec prélèvements SEPA trimestriels sur l'IBAN du mandat. Après paiement, contrôle du dossier et acceptation du risque, votre attestation est disponible dans votre espace client avec un QR code de vérification." },
  ...
  },
  {
    ...
    r: "1) Devis en ligne (/devis) — tarif en quelques minutes, présenté en équivalent mensuel (prime annuelle ÷ 12) avec rappel du prélèvement trimestriel. 2) Souscription — coordonnées de l'entreprise. 3) Création de compte — email et mot de passe. 4) Signature électronique du contrat sur le PDF. 5) Mandat SEPA — IBAN pour les prélèvements trimestriels. 6) Paiement — le premier trimestre et les frais de gestion (60 €) sont réglés par carte bancaire (Mollie) ; les échéances suivantes sont prélevées par SEPA sur l'IBAN du mandat, avec reconduction automatique annuelle. 7) Confirmation — après paiement, contrôle du dossier et acceptation du risque, votre attestation est disponible dans l'espace client.",
    id: "parcours-decennale",
  },
  {
    q: "Quel est le parcours client complet (devis à attestation) ?",
    r: "Parcours décennale : 1) Devis en ligne. 2) Souscription (coordonnées entreprise). 3) Création de compte. 4) Signature électronique du contrat. 5) Mandat SEPA (IBAN). 6) Paiement du 1er trimestre + frais par carte bancaire (Mollie). 7) Après paiement, contrôle du dossier et acceptation du risque, l'attestation est disponible dans l'espace client. Parcours dommage ouvrage : 1) Formulaire DO. 2) Étude et tarif définitif sous environ 24 h. 3) Devis ajouté à l'espace client + dépôt de pièces. 4) Signature électronique. 5) Paiement par virement via Mollie. 6) Attestation après réception du virement et validation du dossier.",
    id: "parcours-client",
  },
  {
