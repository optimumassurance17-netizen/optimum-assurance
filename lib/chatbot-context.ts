...
const FAQ_BASE: { q: string; r: string }[] = [
  ...
  { q: "étapes souscription parcours", r: "1) Devis — tarif en 3 minutes (équivalent mensuel, paiement trimestriel) ; 2) Souscription — coordonnées ; 3) Compte — email et mot de passe ; 4) Signature — Yousign ; 5) Mandat SEPA — IBAN ; 6) Paiement — 1er trimestre + frais par carte, puis prélèvements SEPA trimestriels ; 7) Confirmation — attestation dans l'espace client peu après validation du paiement." },
