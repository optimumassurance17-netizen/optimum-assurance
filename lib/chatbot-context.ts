...
const FAQ_BASE: { q: string; r: string }[] = [
  ...
  { q: "attestation rapidement délai immédiat", r: "En souscrivant en ligne : devis en 3 minutes, signature électronique, 1er trimestre par carte puis mandat SEPA. Votre attestation est disponible IMMÉDIATEMENT dans votre espace client, avec un QR code de vérification. Pas d'attente 24h." },
  ...
  { q: "dommage ouvrage devis DO", r: "Après envoi de votre demande sur devis-dommage-ouvrage, notre équipe vous transmet le prix définitif sous 24h. Le devis est ensuite ajouté à votre espace client. Vous signez électroniquement (Yousign), puis vous payez par virement bancaire via Mollie. L'attestation arrive après réception du virement." },
  { q: "étapes souscription parcours", r: "1) Devis — tarif en 3 minutes (affiché en équivalent mensuel, paiement trimestriel) ; 2) Souscription — coordonnées ; 3) Compte — email et mot de passe ; 4) Signature — Yousign ; 5) IBAN et mandat SEPA ; 6) Paiement — 1er trimestre + frais par carte, puis prélèvements SEPA trimestriels. Attestation immédiate après validation." },
...
- Devis en 3 minutes, signature Yousign, 1er trimestre + frais par carte (Mollie), puis prélèvements SEPA trimestriels sur l’IBAN du mandat
