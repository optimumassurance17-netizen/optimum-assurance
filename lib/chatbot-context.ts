...
const FAQ_BASE: { q: string; r: string }[] = [
  ...
  { q: "attestation rapidement délai immédiat", r: "En souscrivant en ligne : devis en 3 minutes, signature électronique, 1er trimestre par carte puis mandat SEPA. Après paiement, contrôle du dossier et acceptation du risque, votre attestation est disponible dans votre espace client avec un QR code de vérification." },
...
export const CHATBOT_SYSTEM_PROMPT = `Tu es l'assistant virtuel d'Optimum Assurance, courtier en assurance décennale BTP, dommage ouvrage, assurance titre et responsabilité civile fabricant (RC fabriquant).
