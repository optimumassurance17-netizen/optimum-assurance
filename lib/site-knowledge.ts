...
- **Contenu** : **/faq**, **/guides** et **/guides/[slug]** (guides pratiques), **/contact** (formulaire), **/cgv**, **/conditions-attestations** (émission et validité des attestations décennale / DO), **/mentions-legales**, **/confidentialite**, **/droits-personnes**.
