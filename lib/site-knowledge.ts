...
- **Assurance titre** : **/assurance-titre** — formulaire d’étude pour transactions immobilières / refinancements / closings complexes ; **pas de tarif instantané**. Le visiteur décrit l’actif, l’opération, le montant, le calendrier et les risques identifiés (servitude, charge, fraude, empiètement, etc.). Le produit est présenté comme un **complément** aux vérifications notariales / juridiques, avec retour équipe en général sous **24 à 48 h ouvrées**.
...
3. Le produit est présenté comme un **complément** aux vérifications notariales / juridiques ; la faisabilité, les garanties et exclusions dépendent du montage et de la police finalement proposée.
