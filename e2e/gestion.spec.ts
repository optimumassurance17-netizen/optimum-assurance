    ...
    pendingSignatures: [
      {
        ...
        createdAt: "2026-06-09T08:00:00.000Z",
        userId: "legacy_user_sig_1",
        user: null,
        clientLabel: "EXCELLODECO",
        clientUserId: "user_sig_link_1",
        signatureFlow: "decennale",
        ageHours: 30,
        repairEligible: true,
      },
    ...
    insuranceContracts: [
      {
        ...
        exclusionsJson: null,
        clientName: "Excellodeco",
        userId: null,
        clientUserId: "user_contract_link_1",
        premium: 399,
        status: "approved",
        paidAt: null,
        validUntil: null,
...
test.describe("Gestion CRM — accès direct fiche client", () => {
  test("Expose un lien fiche client depuis l'action du jour, la signature en attente et le contrat plateforme", async ({
    page,
  }) => {
    await mockGestionRectificationAuth(page)
