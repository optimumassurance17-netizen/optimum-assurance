...
export async function generateMetadata({
  ...
  const description = `Assurance décennale pour ${data.metierNom} à ${data.villeNom} : obligations, prix indicatif et devis sous 3 minutes. ${data.description.slice(0, 120)}…`
