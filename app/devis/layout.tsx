...
export const metadata: Metadata = {
  ...
  description: `Simulateur assurance décennale : tarif selon votre chiffre d’affaires et vos activités BTP (plombier, électricien, maçon). Dès ${EQ_MENSUEL_MIN} €/mois équivalent. Sans engagement, 100 % en ligne.`,
