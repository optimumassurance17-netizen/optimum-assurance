...
export async function scanAndScoreSeoPages() {
  ...
  await logAiReport({
    ...
    summary: `${scanned} pages scannées, ${weakCount} pages faibles, ${duplicateCount} doublons potentiels`,
    payload: { scanned, weakCount, duplicateCount },
  })

  return { scanned, weakCount, duplicateCount }
}
