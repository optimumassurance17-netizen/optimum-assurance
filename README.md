...
- **Paiement** : 1er trimestre + 60 € frais en **carte bancaire** ; suivants en **prélèvement SEPA trimestriel** avec reconduction automatique annuelle (les montants du site sont des équivalents mensuels à titre indicatif).
...
- **[docs/SEPA-RECURRENT-MOLLIE.md](./docs/SEPA-RECURRENT-MOLLIE.md)** — Feuille de route prélèvements SEPA trimestriels (Mollie, reconduction auto)
